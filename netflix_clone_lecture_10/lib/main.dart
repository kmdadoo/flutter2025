...
import 'package:netflixex/screen/home_screen.dart';
import 'package:netflixex/screen/like_screen.dart';
import 'package:netflixex/screen/more_screen.dart';
...
void main() async {
  ...
  // Firebase.initializeApp(): Firebase 서비스(예: Firestore, Authentication 등)를 사용하기 위해 필요한 설정을 로드하고 초기화합니다. 
  // 이 작업은 네트워크 통신 등을 포함하므로 시간이 걸릴 수 있어 비동기로 처리됩니다.
      ...
      home: DefaultTabController(
        ...
        child: Scaffold(
          ...
          body: TabBarView(
            ...
            children: <Widget>[
              HomeScreen(),  // home_screen.dart 파일에서 가져옴
              SearchScreen(), // search_screen.dart 파일에서 가져옴
              LikeScreen(), // like_screen.dart 파일에서 가져옴
              MoreScreen(), // 프로필 보기. more_screen.dart 파일에서 가져옴
            ],
          ),
